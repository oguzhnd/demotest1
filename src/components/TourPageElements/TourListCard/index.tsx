    ...
    >
      <Parent pos="relative" gap={0} wrap="nowrap" align="stretch" h="100%">
        ...
        <Stack w="100%" p="md" justify="space-between">
          ...
          <Parent justify="space-between" align={matchesSm ? "flex-start" : "flex-end"} wrap="nowrap">
            <Stack gap="xs">
              <Stack gap={0}>
            ...
            <Stack gap={8} w={matchesSm ? "100%" : undefined}>
              <Stack gap={0} align={matchesSm ? "center" : "flex-end"}>
                <Text size="xl" fw={600}>
                  1.399€
                </Text>
              </Stack>
              <Button onClick={onSelect} radius="xl">
                {t("Tour Details")}
              </Button>
            </Stack>
          </Parent>
