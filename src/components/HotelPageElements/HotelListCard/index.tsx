...
const HotelListCard: FC<{
  ...
  return (
    <Paper withBorder radius="md" className={classes.hotelListCard}>
      <Group gap={0} wrap="nowrap">
        ...
        <Stack w="100%" h={200} p="md" justify="space-between" onClick={onSelect}>
          <Stack gap={0}>
            <Text size="lg" fw={500}>
          ...
          <Group w="100%" align="flex-end" justify="space-between">
            ...
            <Stack gap={0} align="flex-end">
              ...
              <Text size="xs" c="gray.7">3 gece, 1 oda için</Text>
              <Text size="xs" c="gray.7">gecelik {(10416).toLocaleString(locale)}</Text>
            </Stack>
          </Group>
        </Stack>
      </Group>
